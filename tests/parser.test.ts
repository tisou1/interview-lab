...
const meta = '<!-- question: {"category":"javascript","type":"coding","difficulty":"intermediate","tags":["Promise"],"estimatedMinutes":10} -->'
...
describe('Markdown source pipeline', () => {
  ...
  it('supports HTML and Markdown answer headings and preserves introductory code', () => {
    const question = parseQuestions(fixture('```js\nconst value = 1\n```\n\n<h3>追问</h3>\n<p>边界</p>\n\n### 易错点\n\n不要遗漏。'))[0]
  ...
  it('sanitizes unsafe HTML and external links', () => {
    const question = parseQuestions(fixture('<script>alert(1)</script>\n\n<img src="x" onerror="alert(1)">\n\n<a href="javascript:alert(1)">bad</a>\n\n[外部](https://example.com)'))[0]
